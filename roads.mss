...
#bridge[render='1_outline'][zoom>=11][zoom<=20]{
  ...
  [zoom=11] {
    ...
    [stylegroup='mainroad'] { line-width: @rdz11_med + 0.8; }
  ...
  [zoom=15] {
    [stylegroup='motorway'] { line-width: @rdz15_maj + 2.5; line-color: #555555;}
    [stylegroup='mainroad'] { line-width: @rdz15_med + 2; line-color: #555555;}
    [stylegroup='minorroad']{ line-width: @rdz15_min; line-color: #555555; }
    [stylegroup='service']  { 
      line-width: 2.5; 
      line-color: #555555;
    }
    [stylegroup='noauto']   { line-width: @rdz15_min / 4 + 2; line-color: #aaa;}
    [stylegroup='railway']  { line-width: 1.5 + 2; }
  }
  [zoom=16] {
    [stylegroup='motorway'] { line-width: @rdz16_maj + 2.5; line-color: #555555;}
    [stylegroup='mainroad'] { line-width: @rdz16_med + 2.5; line-color: #555555;}
    [stylegroup='minorroad']{ line-width: @rdz16_min + 2; line-color: #555555;}
    [stylegroup='service']  { 
      line-width: @rdz16_min / 3 + 2;
      line-color: #555555; 
    }
    [stylegroup='noauto']   { line-width: @rdz16_min / 4 + 2; line-color: #aaa;}
    [stylegroup='railway']  { line-width: 2 + 2;}
  }
  [zoom>=17] {
    [stylegroup='motorway'] { line-width: @rdz17_maj + 3; line-color: #555555;}
    [stylegroup='mainroad'] { line-width: @rdz17_med + 2.5; line-color: #555555;}
    [stylegroup='minorroad']{ line-width: @rdz17_min + 2; line-color: #555555;}
    [stylegroup='service']  { 
      line-width: @rdz17_min / 3 + 2;
      line-color: #555555;
    }
    [stylegroup='noauto']   { line-width: @rdz17_min / 4 + 4; line-color: #aaa;}
    [stylegroup='railway']  { line-width: 3 + 4; } // 3 + 4
  }
  [zoom>=18] {
    [stylegroup='motorway'] { line-width: @rdz18_maj + 4; line-color: #555555;}
    [stylegroup='mainroad'] { line-width: @rdz18_med + 4; line-color: #555555;}
    [stylegroup='minorroad']{ line-width: @rdz18_min + 3.5; line-color: #555555;}
    [stylegroup='service']  { 
      line-width: @rdz18_min / 3 + 3.5;
      line-color: #555555;
    }
    [stylegroup='noauto']   { line-width: @rdz18_min / 4 + 6; line-color: #aaa;}
...
#bridge[render='3_inline'][zoom>=11][zoom<=20]{
  ...
  [zoom=13] {
    ...
    [stylegroup='minorroad']{ line-width: @rdz13_min; }
    [stylegroup='service']  { line-width: 0; } //@rdz13_min / 3; }
    [stylegroup='noauto']   { line-width: @rdz13_min / 4; line-dasharray: 1,1; }
    [stylegroup='railway']  { line-width: 0.8; }
  }
  [zoom=14] {
    [stylegroup='motorway'] { line-width: @rdz14_maj; line-color: #a5a5a5; }
    [stylegroup='mainroad'] { line-width: @rdz14_med; line-color: #a5a5a5; }
    [stylegroup='minorroad']{ line-width: @rdz14_min; line-color: #a5a5a5; }
    [stylegroup='service']  { line-width: @rdz14_min / 3;  line-color: #a5a5a5; line-dasharray: 10, 3, 2, 3;}
  ...
  [zoom=15] {
    ...
    [stylegroup='service']  { line-width: @rdz15_min; line-dasharray: 10, 3, 2, 3;}
  ...
  [zoom=16] {
    ...
    [stylegroup='service']  { line-width: @rdz16_min / 3; line-dasharray: 10, 3, 2, 3;}
  ...
  [zoom=17] {
    ...
    [stylegroup='service']  { line-width: @rdz17_min / 3; line-dasharray: 10, 3, 2, 3;}
  ...
  [zoom>=18] {
    ...
    [stylegroup='service']  { line-width: @rdz18_min / 2; line-dasharray: 10, 3, 2, 3;}
